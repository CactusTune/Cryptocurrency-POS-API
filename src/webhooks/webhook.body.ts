export const coinbase_webhook_body = {
  attempt_number: 1,
  event: {
    ...
    data: {
      ...
      web3_data: {
        ...
        success_events: [
          {
            ...
            tx_hsh:
              '0xc0a731f82af615d7a5f6ba691ba07e083d5403d812adaa8659ed5892c9d3320d',
            finalized: false,
        ...
        transfer_intent: {
          ...
          call_data: {
            ...
            recipient: '0x293a08a589f44a6188d65e92fbcd2a27e93d49e3',
            signature:
              '0xc9b4b26d20ef9e953d145214a335e61495e9d4a559329885952a1b98c72611601e4deb30556b457bdcc1c66ce93976bed9b261447ce7eb770fce70f5216b3a481b',
            fee_amount: '10000',
      ...
      hosted_url:
        'https://commerce.coinbase.com/pay/2aee9dd1-67b8-43ef-8dfe-977959850f27',
      brand_color: '#000000',
      charge_kind: 'WEB3',
      ...
      support_email: '',
      brand_logo_url:
        'https://res.cloudinary.com/commerce/image/upload/v1653516296/dlwoolpero6qgsffxmpz.jpg',
